...
$upload_path = "../admin/cropimage/logo/";				
$upload_path1 = "/green-kokan/admin/cropimage/logo/";		
$thumb_width = "150";						
$thumb_height = "150";						
...
if (isset($_POST["upload_thumbnail"])) {
    ...
    echo $thumb_image_location = $upload_path."thumb_".$_POST['filename'];
    ...
    $query=mysql_query("INSERT INTO `gk_logo` (`logo`) VALUES ('".$thumb_image_location."')");
	$id= mysql_insert_id(); 
    
	//$query=mysql_query("update gk_logo set status =0 where status =1 AND status =''");
	$query=mysql_query("update gk_logo set status ='0'  where id !='".$id."'");
	$query=mysql_query("update gk_logo set status ='1'  where id='".$id."'");	
...
<link rel="stylesheet" type="text/css" href="../admin/cropimage/css/cropimage.css" />
<link type="text/css" href="../admin/cropimage/css/imgareaselect-default.css" rel="stylesheet" />
<script type="text/javascript" src="../admin/cropimage/js/jquery.form.js"></script>
<script type="text/javascript" src="../admin/cropimage/js/jquery.imgareaselect.js"></script>
...
<script type="text/javascript" >
    $(document).ready(function() {
        $('#submitbtn').click(function() {
            ...
            $(".uploadform").ajaxForm({
            	url: '../admin/cropimage/logo_responce.php',
    ...
    $("input[type=file]").change(function(){
        ...
        setTimeout(function(){
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><!--LOGO image--></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
...
<form class="uploadform" id="uploadform" method="post" enctype="multipart/form-data" action='upload.php' name="photo">	
	<div class="crop_set_upload">
		<div class="crop_upload_label">Upload Logo Image: </div>
