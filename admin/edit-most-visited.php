						  ...
						  $location=$_POST['location'];
							...
							else
							{
								if($error == "")
								{
									 ...
									 $query="update `gk_most_visited_place`  set `placename`='".$placename."', `description`='".$description."', `address`='".$address."', `location`='".$location."' where place_id='".$_REQUEST['place_id']."'";
								...
								{ 
										...
										{ 
											...
											//echo "<br/>";
											// Add to database
											$sql = "INSERT INTO `gk_place_images` (`p_id`, `image_name`) VALUES ('".$_REQUEST['place_id']."', '".$name."')";
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                               Edit most visited place Details
                            </div>
...
<?php
$sql = "SELECT * FROM `gk_most_visited_place` where place_id='".$_REQUEST['place_id']."'";
$result = mysql_query($sql);
...
?>									
                                        <form role="form" name="submit" id="signupForm" METHOD="POST" action="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="placename" id="placename" placeholder="placename" value="<?php echo $row['placename'];?>" required>
											...
											<script>
	 function image_delete_p(id,name)
	 {
						//var values = $(this).serialize();

						$.ajax({
						url: "delete_image.php?action=visited&id="+id+"&name="+name,
						type: "post",
						data: id ,
						...
						// you will get response from your php page (what you echo or print)                 
                          //alert(response);
						   $('#delete_'+id).hide();
						                ...
						                $queryam="select id,image_name from gk_place_images where p_id='".$row['place_id']."'";
										 ...
										 ?>
										 <br/>
										 <span id="delete_<?php echo $rowam['id']; ?>" onclick="image_delete_p(<?php echo $rowam['id']; ?>,'<?php echo $rowam['image_name'];?>')"><i class="icon-remove white"></i>
										 <img src="uploadifive/uploads/most_visted_place/<?php echo $rowam['image_name'];?>" width="100" height="100">                                  </span>
										 <?php
										 }
						?>
											<div id="queue"></div> 
...
<br/>	
											...
											<div class="form-group">
                                                ...
                                                <!--<input class="form-control" name="description" id="description" placeholder="Description" value="<?php echo $row['description'];?>" required>-->
											...
											<div class="form-group">
                                                <label>Address</label>
                                                <!--<input class="form-control" name="address" id="address" placeholder="address" value="<?php echo $row['address'];?>">-->
												<textarea class="form-control" rows="3"  name="address" id="address" placeholder="address"><?php echo $row['address'];?></textarea>
                                            </div>
...
<input type="text" name="location" placeholder="Search location" id="location" onchange="codeAddress();" value="<?php echo $row['location'];?>" style="width:500px;">
</div>
<script>		
...
google.maps.event.addListener(autocomplete, 'place_changed', function() {
	...
	console.log(place.address_components);
											...
											<!--<div class="form-group">
                                                <label>Location</label>
                                                <input class="form-control" name="location" id="location" placeholder="Location" value="<?php echo $row['location'];?>">
                                            </div>-->
